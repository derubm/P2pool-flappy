...
function plot(g, unit, total_unit, lines, stack) {
  ...
  d3.select(showhide).append("a")
    ...
    .attr("style", "color:green;text-decoration:underline;cursor:pointer");
...
d3.select("#period_chooser").selectAll().data(periods).enter().append("a")
  ...
  .attr("style", function(d, i) { return (i == 0 ? "" : "margin-left:.4em;") + "color:green;text-decoration:underline;cursor:pointer" });
